...
namespace Latihan_POS.Class
{
    class Edit
    {
        ...
        public void edit(string item, string kode, string nama, string jumlah, string beli, string jual)
        {
            ...
            if (item == "Barang")
            {
                try
                {
                    ...
                    String sql = "UPDATE tblbarang SET nama='" + nama + "'" + "," + "jumlahawal='" + jumlah + "'" + "," + "hargahpp= '" + Convert.ToDecimal(beli) + "'" + "," + "hargajual='" + Convert.ToDecimal(jual) + "'" + "," + "updatedate='" + waktuNow + "'" + "WHERE kodeBarang='" + kode + "'";
        ...
        public void editCustomer(string item, string namaCustomer, string alamat, string noHP)
        {
            conn = new MySqlConnection(connString);
            if (!Angka(noHP))
            {
            ...
            else
            {
                try
                {
                    ...
                    DateTime now = DateTime.Now;
                    String waktuNow = now.ToString("yyyy/MM/dd HH:mm:ss");
                    String sql = "UPDATE tblcustomer SET nama_customer='" + namaCustomer + "'" + "," + "alamat_customer='" + alamat + "'" + "," + "noHPCustomer= '" + noHP + "'" + "," + "updatedate='" + waktuNow + "'" + "WHERE nama_customer='" + namaCustomer + "'";
                    cmd = new MySqlCommand(sql, conn);
                    cmd.ExecuteNonQuery();
                    //MessageBox.Show(sql);
